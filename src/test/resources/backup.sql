...
INSERT into LIDO (nome, indirizzo, telefono, email, logo,prezzo_singolo,num_righe,num_colonne,id_servizi,id_resp_ente) values('Lido Chicco d''Oro','Via Marina Piccola 172, Sorrento','081 8073198','chiccodoro@sorrentomarina.it','/images/chiccodoro.jpg',15.0,6,8,1,1);
INSERT into LIDO (nome, indirizzo, telefono, email, logo,prezzo_singolo,num_righe,num_colonne,id_servizi,id_resp_ente) values('Bagni Regina Margherita','Via Marina Grande 84, Sorrento','081 8781012','margherita@sorrentomarina.it','/images/margherita.jpg',18.5,5,10,2,1);
INSERT into LIDO (nome, indirizzo, telefono, email, logo,prezzo_singolo,num_righe,num_colonne,id_servizi,id_resp_ente) values('Stabilimento Nettuno','Corso Italia 267, Sorrento','081 8073465','nettuno@sorrentomarina.it','/images/nettuno.jpg',22.0,4,12,3,1);
INSERT into LIDO (nome, indirizzo, telefono, email, logo,prezzo_singolo,num_righe,num_colonne,id_servizi,id_resp_ente) values('Lido Solara Beach','Via del Mare 45, Sorrento','081 8074821','solara@sorrentomarina.it','/images/solara.jpg',20.5,7,6,4,1);
