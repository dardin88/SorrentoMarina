...
insert into RESPONSABILE_ENTE(nome, cognome, email, username, password_ente) values ('Marco', 'Rossi', 'marco.rossi@sorrentomarina.it', 'admin', '356a192b7913b04c54574d18c28d46e6395428ab');
insert into RESPONSABILE_ENTE(nome, cognome, email, username, password_ente) values ('Giulia', 'Bianchi', 'giulia.bianchi@sorrentomarina.it', 'giulia', 'da4b9237bacccdf19c0760cab7aec4a8359010b0');
...
insert into RESPONSABILE_LIDO(nome, cognome, email, username, password_responsabile_lido, id_lido, id_resp_ente) values ('Carla', 'Romano', 'carla.romano@chiccodoro.it', 'carla', '356a192b7913b04c54574d18c28d46e6395428ab',1,1);
insert into RESPONSABILE_LIDO(nome, cognome, email, username, password_responsabile_lido, id_lido, id_resp_ente) values ('Francesco', 'Marino', 'francesco.marino@margherita.it', 'francesco', 'da4b9237bacccdf19c0760cab7aec4a8359010b0',2,1);
insert into RESPONSABILE_LIDO(nome, cognome, email, username, password_responsabile_lido, id_lido, id_resp_ente) values ('Sofia', 'Costa', 'sofia.costa@nettuno.it', 'sofia', '77de68daecd823babbb58edb1c8e14d7106e83bb',3,1);
insert into RESPONSABILE_LIDO(nome, cognome, email, username, password_responsabile_lido, id_lido, id_resp_ente) values ('Andrea', 'Sole', 'andrea.sole@solara.it', 'andrea', '1b6453892473a467d07372d45eb05abc2031647a',4,1);
INSERT into TURISTA(nome, cognome, email, username, password_turista) values ('Luca', 'Ferrari', 'luca.ferrari@email.it', 'luca', '356a192b7913b04c54574d18c28d46e6395428ab');
INSERT into TURISTA(nome, cognome, email, username, password_turista) values ('Emma', 'Conti', 'emma.conti@email.it', 'emma', 'da4b9237bacccdf19c0760cab7aec4a8359010b0');
INSERT into TURISTA(nome, cognome, email, username, password_turista) values ('Matteo', 'Ricci', 'matteo.ricci@email.it', 'matteo', '77de68daecd823babbb58edb1c8e14d7106e83bb');
INSERT into TURISTA(nome, cognome, email, username, password_turista) values ('Sara', 'Gallo', 'sara.gallo@email.it', 'sara', '1b6453892473a467d07372d45eb05abc2031647a');
